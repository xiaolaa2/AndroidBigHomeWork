...
class AppActivity : AppCompatActivity() {
    ...
    private fun initTab() {
        ...
        myTabLayout.addTab(myTabLayout.newTab().setIcon(this.getDrawable(R.drawable.home)).setText("主页"))
        myTabLayout.addTab(myTabLayout.newTab().setIcon(this.getDrawable(R.drawable.schedule)).setText("待办"))
        myTabLayout.addTab(myTabLayout.newTab().setIcon(this.getDrawable(R.drawable.info)).setText("统计"))
        myTabLayout.addTab(myTabLayout.newTab().setIcon(this.getDrawable(R.drawable.user)).setText("我的"))
